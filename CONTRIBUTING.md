...
2. Fork the repository by clicking on the ["Fork"](https://github.com/NebulaTris/vibescape/fork) button at the top right corner of the page.


3. Once you are in your fork the url should look something like
`https://github.com/<YOUR-USERNAME>/vibescape/`
...
- For SSH
 ```bash
   git clone git@github.com:<YOUR-USERNAME>/vibescape.git
 ```
...
5. Now you are in the `vibescape` folder
...
>NOTE: Please make sure to follow the [Code of conduct](https://github.com/NebulaTris/vibescape/blob/master/CODE_OF_CONDUCT.md) while contributing.


## Alternatively, using GitHub Codespaces:

1. Follow steps 1 to 3 above, to fork the repository.
2. Navigate to the forked repository i.e. `https://github.com/<YOUR-USERNAME>/vibescape/` 
